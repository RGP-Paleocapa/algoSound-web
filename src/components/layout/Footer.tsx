      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 text-center sm:text-left">
          ...
          <div>
            ...
            <p>Insights into your app and programming concepts.</p>
          </div>
          ...
          <div>
            ...
            <p>Explore additional resources and materials to deepen your understanding your app.</p>
          </div>
        </div>

        {/* Copyright and Legal */}
        <div className="text-center mt-8 border-t pt-4">
          &copy; {startYear}{currentYear > startYear ? `-${currentYear}` : ''} Your App Platform
