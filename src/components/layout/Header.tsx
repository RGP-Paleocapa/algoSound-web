    ...
    <nav className={`fixed w-full z-50 transition-all duration-300 ease-in-out ${show ? 'top-0' : '-top-full'} bg-white dark:bg-slate-800 py-4 px-6 md:px-12 lg:px-16 xl:px-24 shadow-md`}>
      <div className="flex justify-between items-center">
        ...
        <div className="md:flex space-x-4 items-center">
          ...
          <Link to="/explanation" className="text-blue-600 dark:text-blue-400 hover:text-blue-900 dark:hover:text-white" onClick={scrollToTop}>
            Explanation
          </Link>
          <Link to="/coding" className="text-green-600 dark:text-green-400 hover:text-green-900 dark:hover:text-white" onClick={scrollToTop}>
            Coding
          </Link>
          <ThemeSwitcher />
          {/* <LanguageSwitcher /> */}
